...
import 'package:projeto_nw/data/repository/evento_repository.dart';
import 'package:projeto_nw/entities/evento.dart';
import 'package:projeto_nw/ui/widgets/widget_card_evento.dart';
...
class _CursosPageState extends State<CursosPage> {
  ...
  Future<void> listarEventos() async{
    ...
    await EventoRepository.instance.buscarTodosEvento();
    setState((){
