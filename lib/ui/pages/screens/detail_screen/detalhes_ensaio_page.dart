         ...
         Container(
           ...
           child: Card(
             ...
             child: FutureBuilder<List<Cantor>>(
               future: CantorRepository.instance.buscarCantoresPorIds(listaDeParticipantesInt),
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return FutureBuilder<List<Cantor>>(
                        future: CantorRepository.instance.buscarCantoresPorIds([musica!.idCantorSolo!]),
